...
const WomenView = () => {
	...
	const categories = [
		{ id: 1, name: 'Women Shoes', productsCount: 24 },
		{ id: 2, name: 'Women Jeans', productsCount: 8 },
		{ id: 3, name: 'Heels & Flats', productsCount: 16 },
	]
				...
				<div className="flex gap-14">
					...
					<div className="w-full bg-white px-28 py-16">
						<div className="flex items-center gap-1 mb-8">
							...
							<h6 className="font-normal text-gray-500">Women</h6>
						</div>
