...
const MenView = () => {
	...
	const categories = [
		{ id: 1, name: 'Men Shoes', productsCount: 4 },
		{ id: 2, name: 'Men Jeans', productsCount: 10 },
		{ id: 3, name: 'Men Jackets', productsCount: 6 },
	]
				...
				<div className="flex gap-14">
					...
					<div className="w-full bg-white px-28 py-16">
						<div className="flex items-center gap-1 mb-8">
							...
							<h6 className="font-normal text-gray-500">Men</h6>
						</div>
